...
<hr>
        <div class="row">
          <?php
          $card = 1;
            while($rows = mysqli_fetch_array($result) AND ($card <= 6)){
          ?>
          <div class="col-lg-4 mt-4">
            <div class="card" data-aos="zoom-in" data-aos-duration="2000">
              <img src="upload/<?php echo $rows['product'] ?>" height="300px" width="100%" alt="">
              ...
              <div class="card-body">
                ...
                <p><b>Discounted Price : ₹ <?php echo $rows['prize2'] ?></b></p>
                  <form action="pages/customer_login.php">
    ...
    <section class="banner mt-5" id="banner">
      <div class="box2">
        ...
        <a href="pages/customer_login.php" class="btn btn-warning btn-factory-btn">Show More</a>
